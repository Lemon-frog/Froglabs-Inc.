// ---- BALATRO FULLSCREEN BACKGROUND (NO REACT, PURE JS) ---- //
...
vec4 effect(vec2 screenSize, vec2 screen_coords) {
    ...
    vec2 uv = (floor(screen_coords.xy * (1.0 / pixel_size)) * pixel_size - 0.5 * screenSize.xy)
    ...
    return (0.3 / uContrast) * uColor1 +
           (1.0 - 0.3 / uContrast) *
           (uColor1 * c1p + uColor2 * c2p + vec4(c3p * uColor3.rgb, c3p * uColor1.a)) + light;
}
...
document.addEventListener("DOMContentLoaded", startBalatro);
